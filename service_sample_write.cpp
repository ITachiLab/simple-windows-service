...
void svcInit(DWORD dwArgc, LPTSTR *lpszArgv) {
    ...
    while (true) {
        DWORD waitResult = WaitForSingleObject(ghSvcStopEvent, 10000);

        if (waitResult == WAIT_TIMEOUT) {
            HANDLE hFile = CreateFile("C:\\file.txt", GENERIC_WRITE, 0, nullptr, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, nullptr);
            ...
            if (hFile != INVALID_HANDLE_VALUE) {
                ...
                sprintf_s(buffer, 128, "%04d-%02d-%02d %02d:%02d:%02d\r\n", sysTime.wYear, sysTime.wMonth, sysTime.wDay, sysTime.wHour, sysTime.wMinute, sysTime.wSecond);
